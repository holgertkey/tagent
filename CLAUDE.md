...
**Tagent** is a cross-platform text translation tool (v0.11.0+014) built in Rust that supports Windows and Linux (X11 with full features, Wayland with interactive/CLI modes). It provides three translation modes:
